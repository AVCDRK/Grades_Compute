...
require(tidyverse)
require(tigerstats)
alldata <- read.csv(file = "Grades-2019-37305-MATH115.csv")
#names(alldata)
```
...
```{r}
rollup$grade <- rollup$HworkNorm*12.5 + rollup$QuizNorm*12.5 + rollup$DcampNorm*20 + rollup$WriteupNorm*20 + rollup$GitNorm*10 + rollup$FinalNorm*25
